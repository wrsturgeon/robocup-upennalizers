...
camera.param[4] = {key='Exposure'       , val={100 , 200}};
-- Gain should be set between 32 and 255
camera.param[5] = {key='Gain'       , val={180 , 140}};
...
camera.param[12] = {key='White Balance Temperature'       , val={4800 , 5315}}
...
camera.lut_file = {'lutTOPdanpak_Japan_July292017_4PM.raw', 'lutBOTTOMdanpak_Japan_July292017_4PM.raw'};
