...
------------------------------------
--Nao values
fsm.bodyPosition.rTurn = 0.25;   --for velgeneration 
fsm.bodyPosition.rTurn2 = 0.08;  --for velgeneration 
fsm.bodyPosition.rDist1 = 0.60;  --for targetpose
fsm.bodyPosition.rDist2 = 0.40;  --for targetpose
fsm.bodyPosition.rClose = 0.425;  --for ball close
fsm.bodyPosition.rOrbit = 0.225;  --for targetpose how close are robot turn from the ball
 
fsm.bodyPosition.thClose = {0.3, 0.2, 20*math.pi/180};  --threshold for transition to bodyOrbit/Approach
...
fsm.bodyApproach.xTarget21 = {0.1, 0.16, 0.20}; --min, target, max 
