...
world.postYellow = {};
world.postYellow[1] = {4.0, 0.85};
world.postYellow[2] = {4.0, -0.85};
world.postCyan = {};
world.postCyan[1] = {-4.0, -0.85};
world.postCyan[2] = {-4.0, 0.85};
world.spot = {};
world.spot[1] = {-2.7, 0};
world.spot[2] = {2.7, 0};
...
world.Lcorner={};
--Field edge
world.Lcorner[1]={4.0,2.55,-0.75*math.pi};
world.Lcorner[2]={4.0,-2.55,0.75*math.pi};
world.Lcorner[3]={-4.0,2.55,-0.25*math.pi};
world.Lcorner[4]={-4.0,-2.55,0.25*math.pi};
--Penalty box edge
world.Lcorner[5]={-3.4,1.1,-0.75*math.pi};
world.Lcorner[6]={-3.4,-1.1,0.75*math.pi};
world.Lcorner[7]={3.4,1.1,-0.25*math.pi};
world.Lcorner[8]={3.4,-1.1,0.25*math.pi};
--Penalty box T edge
world.Lcorner[9]={4.0,1.1,-0.75*math.pi};
world.Lcorner[10]={4.0,-1.1,0.75*math.pi};
world.Lcorner[11]={-4.0,1.1,-0.25*math.pi};
world.Lcorner[12]={-4.0,-1.1,0.25*math.pi};

world.Lcorner[13]={4.0,1.1,0.75*math.pi};
world.Lcorner[14]={4.0,-1.1,-0.75*math.pi};
world.Lcorner[15]={-4.0,1.1,0.25*math.pi};
world.Lcorner[16]={-4.0,-1.1,-0.25*math.pi};
...
world.Lcorner[21]={0,0.7,-0.25*math.pi};
world.Lcorner[22]={0,0.7,0.25*math.pi};
world.Lcorner[23]={0,0.7,-0.75*math.pi};
world.Lcorner[24]={0,0.7,0.75*math.pi};
world.Lcorner[25]={0,-0.7,-0.25*math.pi};
world.Lcorner[26]={0,-0.7,0.25*math.pi};
world.Lcorner[27]={0,-0.7,-0.75*math.pi};
world.Lcorner[28]={0,-0.7,0.75*math.pi};
...
world.Tcorner[1]={4.0,1.1,math.pi};
world.Tcorner[2]={4.0,-1.1,math.pi};
world.Tcorner[3]={-4.0,1.1,0};
world.Tcorner[4]={-4.0,-1.1,0};
--cirlce T corners
...
world.initPositionSidelines={
  {4.0, 2.55,-math.pi/2}, --Player 1, goalie on field corner to right of goal
  {0.7, 2.55,-math.pi/2}, --Player 2, attacker aligned base of circle on the right side of goal
  {2.7, 2.55,-math.pi/2}, --Player 3, defender aligned with penalty cross on right side
  {0.7,-2.55, math.pi/2}, --Player 4, supporter aligned base of circle on the left side of goal
  {2.7,-2.55, math.pi/2}, --Player 5, defender2 aligned with penalty cross on left side
}
