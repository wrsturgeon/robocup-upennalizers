...
if Config.game.playerID > 1 then
    ...
    --Circle observation
        world.rCircleFilterTop = 0.001;
        world.aCircleFilterTop = 0.005;
...
world.odomScale = {1.11, 1.2, 1} --for walking forwards
