...
sm: set_transition(bodyHandleKickOff, 'walkkick', bodyWalkKick)
...
sm:set_transition(bodyPosition, 'trackTeamBall', bodyStill);
...
sm:set_transition(bodySearchTeam, 'teamBall', bodyPosition);
...
sm:set_transition(bodyOrbit, 'freeKick', bodyPosition);
sm:set_transition(bodyOrbit, 'done', bodyApproach);

sm:set_transition(bodyApproach, 'ballFar', bodyPosition);
sm:set_transition(bodyApproach, 'freeKick', bodyPosition);
sm:set_transition(bodyApproach, 'ballOrbit', bodyOrbit);
