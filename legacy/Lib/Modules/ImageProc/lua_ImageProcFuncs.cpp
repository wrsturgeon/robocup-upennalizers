...
static const struct luaL_Reg imageProcFuncs_lib [] = {
  ...
  {"integral_image", lua_integral_image},
  {"diff_img", lua_diff_img},
  {"local_max", lua_local_max},
	{"high_contrast_parts", lua_high_contrast_parts},
	{"top_most_row", lua_top_most_row},

  {"im_rescale_idx", lua_im_rescale_idx},
  {"bilinear_interp",lua_bilinear_interp},

  {"integral_image2", lua_integral_image2},
  {"high_contrast_parts2", lua_high_contrast_parts2},
  {"top_most_row2", lua_top_most_row2},
  {"diff_img2", lua_diff_img2},
  {"local_max2", lua_local_max2},

  //{"nn_predict", lua_nn_predict},
