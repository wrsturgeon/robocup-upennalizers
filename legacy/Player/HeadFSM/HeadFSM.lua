...
sm:set_transition(headTrack, 'lost', headScanStill);
...
sm:set_transition(headTrackGoalie, 'lost', headScanStill);

sm:set_transition(headKick, 'ballFar', headTrack);
sm:set_transition(headKick, 'ballLost', headScanStill);
sm:set_transition(headKick, 'timeout', headTrack);

sm:set_transition(headKickFollow, 'lost', headScanStill);
...
sm:set_transition(headScanStill, 'ball', headTrack);
sm:set_transition(headScanStill, 'timeout', headScanStill);
