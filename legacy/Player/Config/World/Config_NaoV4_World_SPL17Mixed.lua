...
if Config.game.playerID > 1 then
	...
	world.aLCornerFilterTop = 0.001
	
	--T Corner observation - top
	world.rTCornerFilterTop = 0.001;
	world.aTCornerFilterTop = 0.001;
    ...
    --Circle observation
        world.rCircleFilterTop = 0; --0.005
        world.aCircleFilterTop = 0; --0.01
...
world.initPosition2 = world.initPosition1;
...
world.initPositionSidelines={
  ...
  {0.75, -3 ,math.pi/2}, --Player 2, attacker aligned base of circle on right side of goal
  {3.2, -3.0,math.pi/2}, --Player 3, defender aligned with penalty spot on right side
  {0.75,-3.0, math.pi/2}, --Player 4, supporter aligned with base of circle on left side of goal
  {3.2,-3.0, math.pi/2}, --Player 5, defender2 aligned with penalty spot on left side
  {3.9,-3.0,math.pi/2}  --Player 6 us!
}
...
world.odomScale = {1.15, 1.2, 1} --for walking forwards
world.odomScale2 = {0.9, 1.2, 1} -- for walking backwards
