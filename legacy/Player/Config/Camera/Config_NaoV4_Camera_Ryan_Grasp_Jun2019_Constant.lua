...
camera.param[14] = {key='Auto Exposure', val={0, 0}};
...
camera.param[16] = {key='Brightness', val={18, 16}}; -- Only changeable while auto exposure is enabled!



camera.lut_file = {'PranavLUT.raw','PranavLUT.raw'};
