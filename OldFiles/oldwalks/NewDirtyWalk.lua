...
is_stopped = false
stop_threshold = {13*math.pi/180,18*math.pi/180}
tStopStart = 0
tStopDuration = 2.0
...
--NAO SPECIFIC
  uTorsoActual[3]=(uLeft[3]+uRight[3])/2
...
function update_velocity()
  ...
  print("Velocity:",velCurrent[1],velCurrent[2],velCurrent[3]*180/math.pi)
end
